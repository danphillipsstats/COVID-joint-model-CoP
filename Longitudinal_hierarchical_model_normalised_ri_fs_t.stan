...
// Individual-level random intercept only.
// The model allows for covariate effects on intercept and slope.
...
transformed parameters {
	...
	a_1_tf = X_l1_tf*beta_l1_tf + alpha_1_tf;   // Slope unconstrained (not forced to be negative)
